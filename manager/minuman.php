...
if (isset($_POST['tambah_menu'])) {
    ...
    if ($result) {
        ...
        echo "<script>location='index.php?page=minuman';</script>";
    } else {
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Menu Minuman</h1>
        ...
        <div class="table-responsive">
            <table class="tablesaw table-striped table-hover table-bordered table" data-tablesaw-mode="columntoggle" id="data-tables">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $query = "SELECT * FROM t_menu where kategori = 'minuman' ";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        <label class="control-label">Harga</label>
                        <input type="text" class="form-control" id="harga2" name="harga" required>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Kategori</label>
                        <select class="form-control" name="kategori" required>
